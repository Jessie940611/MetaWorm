...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 neuron_to_neuron_exc_syn C:/Users/maxy/PycharmProjects/SingleNeuron/generator/data/mechanism/modfile/neuron_to_neuron_exc_syn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "neuron_to_neuron_exc_syn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
