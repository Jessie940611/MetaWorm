...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 neuron_to_neuron_inh_syn C:/Users/maxy/PycharmProjects/SingleNeuron/generator/data/mechanism/modfile/neuron_to_neuron_inh_syn.mod\n");
...
static int  rates (  ) {
   inf = 1.0 / ( 1.0 + exp ( ( Vth - vpeer ) / delta ) ) ;
   tau = ( 1.0 - inf ) / k ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "neuron_to_neuron_inh_syn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
