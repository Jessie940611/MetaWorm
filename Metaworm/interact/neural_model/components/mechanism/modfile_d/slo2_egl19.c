...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 slo2_egl19 C:/Users/maxy/PycharmProjects/SingleNeuron/generator/data/mechanism/modfile/slo2_egl19.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "slo2_egl19.mod";
static const char* nmodl_file_text = 
