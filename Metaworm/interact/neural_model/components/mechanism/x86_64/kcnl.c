...
#define nrn_init _nrn_init__kcnl
#define _nrn_initial _nrn_initial__kcnl
#define nrn_cur _nrn_cur__kcnl
#define _nrn_current _nrn_current__kcnl
#define nrn_jacob _nrn_jacob__kcnl
#define nrn_state _nrn_state__kcnl
#define _net_receive _net_receive__kcnl 
#define setparames setparames__kcnl 
#define states states__kcnl 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kcnl", _hoc_setdata,
 "setparames_kcnl", _hoc_setparames,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kcnl /home/mahchine/DynamicNeuronX/dev_mahchine_worm_intergrate/dynamicneuronx/Metaworm/interact/neural_model/components/mechanism/modfile/kcnl.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "kcnl current for C. elegans neuron model";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mahchine/DynamicNeuronX/dev_mahchine_worm_intergrate/dynamicneuronx/Metaworm/interact/neural_model/components/mechanism/modfile/kcnl.mod";
static const char* nmodl_file_text = 
