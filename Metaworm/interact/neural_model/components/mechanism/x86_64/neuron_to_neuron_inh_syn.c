...
#define nrn_init _nrn_init__neuron_to_neuron_inh_syn
#define _nrn_initial _nrn_initial__neuron_to_neuron_inh_syn
#define nrn_cur _nrn_cur__neuron_to_neuron_inh_syn
#define _nrn_current _nrn_current__neuron_to_neuron_inh_syn
#define nrn_jacob _nrn_jacob__neuron_to_neuron_inh_syn
#define nrn_state _nrn_state__neuron_to_neuron_inh_syn
#define _net_receive _net_receive__neuron_to_neuron_inh_syn 
#define rates rates__neuron_to_neuron_inh_syn 
#define states states__neuron_to_neuron_inh_syn 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _neuron_to_neuron_inh_syn_reg() {
	int _vectorized = 0;
  _initlists();
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 neuron_to_neuron_inh_syn /home/mahchine/DynamicNeuronX/dev_mahchine_worm_intergrate/dynamicneuronx/Metaworm/interact/neural_model/components/mechanism/modfile/neuron_to_neuron_inh_syn.mod\n");
...
{
 { error =  states();
 if(error){fprintf(stderr,"at line 80 in file neuron_to_neuron_inh_syn.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mahchine/DynamicNeuronX/dev_mahchine_worm_intergrate/dynamicneuronx/Metaworm/interact/neural_model/components/mechanism/modfile/neuron_to_neuron_inh_syn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
