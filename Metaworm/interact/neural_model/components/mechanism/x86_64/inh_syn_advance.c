...
#define nrn_init _nrn_init__inh_syn_advance
#define _nrn_initial _nrn_initial__inh_syn_advance
#define nrn_cur _nrn_cur__inh_syn_advance
#define _nrn_current _nrn_current__inh_syn_advance
#define nrn_jacob _nrn_jacob__inh_syn_advance
#define nrn_state _nrn_state__inh_syn_advance
#define _net_receive _net_receive__inh_syn_advance 
#define rates rates__inh_syn_advance 
#define states states__inh_syn_advance 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 inh_syn_advance /home/mahchine/DynamicNeuronX/dev_mahchine_worm_intergrate/dynamicneuronx/Metaworm/interact/neural_model/components/mechanism/modfile/inh_syn_advance.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mahchine/DynamicNeuronX/dev_mahchine_worm_intergrate/dynamicneuronx/Metaworm/interact/neural_model/components/mechanism/modfile/inh_syn_advance.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
