...
#define nrn_init _nrn_init__egl2
#define _nrn_initial _nrn_initial__egl2
#define nrn_cur _nrn_cur__egl2
#define _nrn_current _nrn_current__egl2
#define nrn_jacob _nrn_jacob__egl2
#define nrn_state _nrn_state__egl2
#define _net_receive _net_receive__egl2 
#define setparames setparames__egl2 
#define states states__egl2 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_egl2", _hoc_setdata,
 "setparames_egl2", _hoc_setparames,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 egl2 /home/mahchine/DynamicNeuronX/dev_mahchine_worm_intergrate/dynamicneuronx/Metaworm/interact/neural_model/components/mechanism/modfile/egl2.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "egl2 current for C. elegans neuron model";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mahchine/DynamicNeuronX/dev_mahchine_worm_intergrate/dynamicneuronx/Metaworm/interact/neural_model/components/mechanism/modfile/egl2.mod";
static const char* nmodl_file_text = 
