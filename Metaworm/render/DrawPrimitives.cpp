...
void GUI::DrawTetrahedron(const Eigen::Vector3d& p0,const Eigen::Vector3d& p1,const Eigen::Vector3d& p2,const Eigen::Vector3d& p3,
						  const Eigen::Vector4d& color, const bool& draw_line, const double& line_width)
{
...
void GUI::DrawTriangle(const Eigen::Vector3d& p0, const Eigen::Vector3d& p1, const Eigen::Vector3d& p2,
...
void GUI::DrawLine(const Eigen::Vector3d& p0, const Eigen::Vector3d& p1, const Eigen::Vector4d& color, const double& line_width)
{
	glEnable(GL_LIGHTING);
	glEnable(GL_BLEND);
	glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
...
void GUI::DrawPoint(const Eigen::Vector3d& p0, const double& size, const Eigen::Vector4d& color)
{
	glEnable(GL_LIGHTING);
	glEnable(GL_BLEND);
	glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
...
void GUI::DrawCylinder(const Eigen::Vector3d& p0, const Eigen::Vector3d& p1, const double& line_width, const Eigen::Vector4d& color)
{
...
void GUI::DrawCylinder(double radius, double height, int slices, int stacks)
{
  glPushMatrix();
...
void GUI::DrawTorus(const Eigen::Vector3d& center, const double& r, const Eigen::Vector3d& dir, const Eigen::Vector4d& color)
{
	glEnable(GL_LIGHTING);
	glEnable(GL_BLEND);
	glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
...
void GUI::DrawArrow3D(const Eigen::Vector3d& _pt, const Eigen::Vector3d& _vec, const double _thickness,
					  const Eigen::Vector3d& color, const double _arrowThickness)
{
	glEnable(GL_LIGHTING);
...
void GUI::DrawAxis(const Eigen::Vector3d& base)
{
	GUI::DrawArrow3D(base, Eigen::Vector3d(1, 0, 0), 0.01, Eigen::Vector3d(1, 0, 0));
	GUI::DrawArrow3D(base, Eigen::Vector3d(0, 1, 0), 0.01, Eigen::Vector3d(0, 1, 0));
	GUI::DrawArrow3D(base, Eigen::Vector3d(0, 0, 1), 0.01, Eigen::Vector3d(0, 0, 1));
}