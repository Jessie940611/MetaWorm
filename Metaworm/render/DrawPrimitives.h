...
namespace GUI
{
	void DrawTetrahedron(const Eigen::Vector3d& p0,const Eigen::Vector3d& p1,const Eigen::Vector3d& p2,const Eigen::Vector3d& p3,
		const Eigen::Vector4d& color = Eigen::Vector4d(0.8,0.8,0.8,0.2),const bool& draw_line=true, const double& line_width=1.0);
	...
	void DrawAxis(const Eigen::Vector3d& base);
};
#endif