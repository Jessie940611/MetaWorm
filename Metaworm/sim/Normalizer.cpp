...
Normalizer::Normalizer(const Eigen::VectorXd& real_val_max, const Eigen::VectorXd& real_val_min,
...
Eigen::VectorXd Normalizer::RealToNorm(const Eigen::VectorXd& val)
{
...
Eigen::VectorXd Normalizer::NormToReal(const Eigen::VectorXd& val)
{
	Eigen::VectorXd val_0_1(mDim);
