...
#define nrn_init _nrn_init__exc_syn_advance
#define _nrn_initial _nrn_initial__exc_syn_advance
#define nrn_cur _nrn_cur__exc_syn_advance
#define _nrn_current _nrn_current__exc_syn_advance
#define nrn_jacob _nrn_jacob__exc_syn_advance
#define nrn_state _nrn_state__exc_syn_advance
#define _net_receive _net_receive__exc_syn_advance 
#define rates rates__exc_syn_advance 
#define states states__exc_syn_advance 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 exc_syn_advance /home/brains/worm_simulation/interact/worm-simulation/eworm/components/mechanism/modfile/exc_syn_advance.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/brains/worm_simulation/interact/worm-simulation/eworm/components/mechanism/modfile/exc_syn_advance.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
