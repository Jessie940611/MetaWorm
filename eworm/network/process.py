...
def circuit_search(sim_config, save_dir, search_config=None, data_config=None, weight_config=None):
    """generating circuit simulation result
    ...
    simplify_connection = weight_config.get("simplify_connection", False)
    cluster_connection = weight_config.get("cluster_connection", True)
    net_type = weight_config.get("net_type", "detailed")
    # preparation
